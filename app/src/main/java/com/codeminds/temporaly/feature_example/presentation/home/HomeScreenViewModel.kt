...
import com.codeminds.temporaly.feature_example.domain.usecase.GetTimerSessionByDateUseCase
import com.codeminds.temporaly.feature_example.domain.usecase.SaveTimerSessionUseCase
import com.codeminds.temporaly.feature_example.utils.Constans.Companion.ONE_HOUR_IN_MIN
import com.codeminds.temporaly.feature_example.utils.Constans.Companion.ONE_MIN_IN_MILLIS
import com.codeminds.temporaly.feature_example.utils.Constans.Companion.ONE_MIN_IN_SEC
import com.codeminds.temporaly.feature_example.utils.Constans.Companion.ONE_SEC_IN_MILLIS
...
//        }
    ...
    private fun saveTimerSession(){
        ...
        saveTimerSessionUseCase(timerSessionModel = session).onEach { result ->
            when(result) {
                is Resource.Success -> { _sessionTimerValue = 0}
                is Resource.Loading -> {}
                is Resource.Error -> {}
            }
        }.launchIn(viewModelScope)
